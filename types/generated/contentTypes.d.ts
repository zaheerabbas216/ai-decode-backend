...
export interface ApiWebinarWebinar extends Schema.CollectionType {
  ...
  attributes: {
    webinar_name: Attribute.String;
    webinar_date: Attribute.DateTime;
    webinar_location: Attribute.String;
    webinar_overview: Attribute.Text;
    webinar_host_info: Attribute.Text;
    webinar_host_name: Attribute.String;
    webinar_host_desig: Attribute.String;
    webinar_image: Attribute.Media;
    webinar_price: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
